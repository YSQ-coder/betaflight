...
void pgResetFn_barometerConfig(barometerConfig_t *barometerConfig)
{
    ...
    defined(DEFAULT_BARO_LPS22DF) || defined(DEFAULT_BARO_SPI_LPS22DF) || defined(DEFAULT_BARO_LPS22H) || defined(DEFAULT_BARO_SPI_LPS22H)
